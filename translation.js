export const translations = {
  ar: {
    ...
    "proj-link-github": "عرض المشروع على GitHub",
    "certs-title": "الشهادات والدورات",
    "cs-certif": "علوم الحاسوب (أكاديمية حسوب - 62 ساعة)",
    "flutter-certif": "تطوير تطبيقات بفلاتر (يودمي - 56 ساعة)",
    "ccna-certif": "شبكات (معهد كليفر - 80 ساعة)",
    "data-analysis-certif": "تحليل البيانات (معهد كليفر - 80 ساعة)",
    "mikrotik-certif": "ميكروتيك (معهد كليفر - 40 ساعة)",
    "cctv-certif": "أنظمة المراقبة (معهد كليفر - 40 ساعة)",
    "cs-certif-desc": "فهم عميق لعمل الحواسيب والبرمجيات، وليس مجرد استخدامها",
    "flutter-certif-desc": "تطوير تطبيقات الموبايل باستخدام Dart",
    "ccna-certif-desc": "شهادة سيسكو في الشبكات",
    "data-analysis-certif-desc": "شهادة احترافية في تحليل البيانات",
    "mikrotik-certif-desc": "إدارة الشبكات باستخدام ميكروتيك",
    "cctv-certif-desc": "أنظمة المراقبة بالفيديو",
    ...
    "proj-link-github": "View Project on GitHub",
    "certs-title": "Certifications",
    "cs-certif": "Computer Science (Hsoub Academy - 62H)",
    "flutter-certif": "Flutter Application Development (Udemy - 56H)",
    "ccna-certif": "CCNA (Clever Institute - 80H)",
    ...
    "mikrotik-certif-desc": "Network Management using MikroTik",
    "cctv-certif-desc": "Closed-Circuit TeleVision",
